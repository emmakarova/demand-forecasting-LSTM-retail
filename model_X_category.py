...
DATA_PATH = "~/магистър ИИБФ/дипломна/data/model/processed/daily_sales_1498_with_weather.csv"
BARCODE = "1498"
RANDOM_SEED = 42
...
log_path = "~/магистър ИИБФ/дипломна/data/model/processed/lstm_log_entries_X.csv"
